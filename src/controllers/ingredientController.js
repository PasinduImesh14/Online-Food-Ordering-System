...
module.exports = {
    createIngredientCategory: async (req, res) => {
        try {
            ...
            const items = await ingredientService.createIngredientsCategory(name, restaurantId);
    ...
    createIngredient: async (req, res) => {
        try {
            ...
            const item = await ingredientService.createIngredientsItem(restaurantId, name, ingredientCategoryId);
